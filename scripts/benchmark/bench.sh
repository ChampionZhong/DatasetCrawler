...
end_date=$(date -d "${timestamp} - 30 days" +'%Y-%m-%d')
...
python 1_crawler.py -o "data/benchmark/benchmark_${timestamp}/1_benchmark_crawler_${timestamp}.pkl"
...
python utils/json2xlsx.py -i "data/benchmark/benchmark_${timestamp}/3_benchmark_classified_${timestamp}.jsonl" -o "data/benchmark/benchmark_${timestamp}/3_benchmark_classified_${timestamp}.xlsx"